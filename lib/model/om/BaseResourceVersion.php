...
abstract class BaseResourceVersion extends BaseObject  implements Persistent {
  ...
  const PEER = 'ResourceVersionPeer';
	...
	/**
	 * @var        Criteria The criteria used to select the current contents of collResourceVersionsRelatedByResourceVersionId.
	 */
	private $lastResourceVersionRelatedByResourceVersionIdCriteria = null;
	...
	/**
	 * @var        Criteria The criteria used to select the current contents of collResourceAttributeVersionHashs.
	 */
	private $lastResourceAttributeVersionHashCriteria = null;
	...
	/**
	 * Initializes internal state of BaseResourceVersion object.
	 * @see        applyDefaults()
	 */
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		if ($deep) {  // also de-associate any related objects?
			...
			$this->aResourceVersionRelatedByResourceVersionId = null;
			$this->collResourceVersionsRelatedByResourceVersionId = null;
			$this->lastResourceVersionRelatedByResourceVersionIdCriteria = null;

			$this->collResourceAttributeVersionHashs = null;
			$this->lastResourceAttributeVersionHashCriteria = null;
	...
	public function setResourceVersionRelatedByResourceVersionId(ResourceVersion $v = null)
	{
		...
		if ($v !== null) {
			$v->addResourceVersionRelatedByResourceVersionId($this);
		}
	...
	public function getResourceVersionRelatedByResourceVersionId(PropelPDO $con = null)
	{
		if ($this->aResourceVersionRelatedByResourceVersionId === null && ($this->resource_version_id !== null)) {
			...
			$this->aResourceVersionRelatedByResourceVersionId = ResourceVersionPeer::doSelectOne($c, $con);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aResourceVersionRelatedByResourceVersionId->addResourceVersionsRelatedByResourceVersionId($this);
			 */
		}
	...
	/**
	 * Clears out the collResourceVersionsRelatedByResourceVersionId collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 * @return     void
	 * @see        addResourceVersionsRelatedByResourceVersionId()
	 */
	public function clearResourceVersionsRelatedByResourceVersionId()
	{
		$this->collResourceVersionsRelatedByResourceVersionId = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collResourceVersionsRelatedByResourceVersionId collection (array).
	 *
	 * By default this just sets the collResourceVersionsRelatedByResourceVersionId collection to an empty array (like clearcollResourceVersionsRelatedByResourceVersionId());
	 ...
	 * Otherwise if this ResourceVersion has previously been saved, it will retrieve
	 * related ResourceVersionsRelatedByResourceVersionId from storage. If this ResourceVersion is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 * @return     array ResourceVersion[]
	 * @throws     PropelException
	 */
	public function getResourceVersionsRelatedByResourceVersionId($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ResourceVersionPeer::DATABASE_NAME);
		}
		...
		if ($this->collResourceVersionsRelatedByResourceVersionId === null) {
			if ($this->isNew()) {
			   $this->collResourceVersionsRelatedByResourceVersionId = array();
				...
				$criteria->add(ResourceVersionPeer::RESOURCE_VERSION_ID, $this->id);
	 ...
	 * @throws     PropelException
	 */
	public function countResourceVersionsRelatedByResourceVersionId(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ResourceVersionPeer::DATABASE_NAME);
		} else {
		...
		if ($this->collResourceVersionsRelatedByResourceVersionId === null) {
			if ($this->isNew()) {
				...
				$count = ResourceVersionPeer::doCount($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				if (!isset($this->lastResourceVersionRelatedByResourceVersionIdCriteria) || !$this->lastResourceVersionRelatedByResourceVersionIdCriteria->equals($criteria)) {
					...
					$count = count($this->collResourceVersionsRelatedByResourceVersionId);
				}
			} else {
				$count = count($this->collResourceVersionsRelatedByResourceVersionId);
			}
	...
	{
		if ($this->collResourceVersionsRelatedByResourceVersionId === null) {
			$this->initResourceVersionsRelatedByResourceVersionId();
		}
		if (!in_array($l, $this->collResourceVersionsRelatedByResourceVersionId, true)) { // only add it if the **same** object is not already associated
			array_push($this->collResourceVersionsRelatedByResourceVersionId, $l);
			$l->setResourceVersionRelatedByResourceVersionId($this);
		}
	}

	/**
	 * Clears out the collResourceAttributeVersionHashs collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	...
	/**
	 * Initializes the collResourceAttributeVersionHashs collection (array).
	 *
	...
	{
		$this->collResourceAttributeVersionHashs = array();
	}
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this ResourceVersion has previously been saved, it will retrieve
	 * related ResourceAttributeVersionHashs from storage. If this ResourceVersion is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 * @return     array ResourceAttributeVersionHash[]
	 * @throws     PropelException
	 */
		...
		if ($this->collResourceAttributeVersionHashs === null) {
			if ($this->isNew()) {
			   $this->collResourceAttributeVersionHashs = array();
				...
				$criteria->add(ResourceAttributeVersionHashPeer::RESOURCE_VERSION_ID, $this->id);

				ResourceAttributeVersionHashPeer::addSelectColumns($criteria);
				$this->collResourceAttributeVersionHashs = ResourceAttributeVersionHashPeer::doSelect($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				ResourceAttributeVersionHashPeer::addSelectColumns($criteria);
				if (!isset($this->lastResourceAttributeVersionHashCriteria) || !$this->lastResourceAttributeVersionHashCriteria->equals($criteria)) {
					$this->collResourceAttributeVersionHashs = ResourceAttributeVersionHashPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastResourceAttributeVersionHashCriteria = $criteria;
	...
	public function countResourceAttributeVersionHashs(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		...
		if ($this->collResourceAttributeVersionHashs === null) {
			if ($this->isNew()) {
				...
				$count = ResourceAttributeVersionHashPeer::doCount($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				if (!isset($this->lastResourceAttributeVersionHashCriteria) || !$this->lastResourceAttributeVersionHashCriteria->equals($criteria)) {
					...
					$count = count($this->collResourceAttributeVersionHashs);
				}
			} else {
				$count = count($this->collResourceAttributeVersionHashs);
			}
	...
	public function addResourceAttributeVersionHash(ResourceAttributeVersionHash $l)
	{
		...
		if (!in_array($l, $this->collResourceAttributeVersionHashs, true)) { // only add it if the **same** object is not already associated
			array_push($this->collResourceAttributeVersionHashs, $l);
	...
	public function getResourceAttributeVersionHashsJoinResourceAttributeVersion($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		if ($this->collResourceAttributeVersionHashs === null) {
			if ($this->isNew()) {
				...
				$this->collResourceAttributeVersionHashs = ResourceAttributeVersionHashPeer::doSelectJoinResourceAttributeVersion($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	{
		if ($deep) {
			if ($this->collResourceVersionsRelatedByResourceVersionId) {
				foreach ((array) $this->collResourceVersionsRelatedByResourceVersionId as $o) {
